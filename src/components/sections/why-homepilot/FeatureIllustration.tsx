    ...
    >
      <div className="absolute inset-x-12 top-1/2 hidden h-px -translate-y-1/2 overflow-hidden bg-border/60 sm:block">
        <motion.div
          ...
          animate={shouldAnimate ? { x: ["-100%", "400%"] } : undefined}
        ...
        {steps.map((step, index) => (
          ...
          >
            <motion.div
              ...
              className="relative z-10 flex items-center gap-3 rounded-2xl border border-border/60 bg-card/85 p-4 shadow-lg backdrop-blur-md"
            >
